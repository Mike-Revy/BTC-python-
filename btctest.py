...
# Generate a randome private keys
...
# add suffix "01" to indicate a compressed private keys
compressed_private_key = private_key + '01'
print("private Key compressed (hex) is: ", compressed_private_key)

# Generate a WIF format from the compressed private key (WIF_compressed)
